  ...
  writing: {
    ...
    scripts: function() {
      ...
      if (this.includeAngular) {
        ...
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/autocomplete.component.js'),
          this.destinationPath('app/js/home/components/autocomplete.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/breadcrumbs.component.js'),
          this.destinationPath('app/js/home/components/breadcrumbs.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/header.component.js'),
          this.destinationPath('app/js/home/components/header.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/hello.component.js'),
          this.destinationPath('app/js/home/components/hello.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/list.component.js'),
          this.destinationPath('app/js/home/components/list.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/notification.component.js'),
          this.destinationPath('app/js/home/components/notification.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/search.component.js'),
          this.destinationPath('app/js/home/components/search.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/translate.component.js'),
          this.destinationPath('app/js/home/components/translate.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/components/patientSearch.component.js'),
          this.destinationPath('app/js/home/components/patientSearch.component.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/autocomplete.controller.js'),
          this.destinationPath('app/js/home/controllers/autocomplete.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/breadcrumbs.controller.js'),
          this.destinationPath('app/js/home/controllers/breadcrumbs.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/header.controller.js'),
          this.destinationPath('app/js/home/controllers/header.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/hello.controller.js'),
          this.destinationPath('app/js/home/controllers/hello.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/list.controller.js'),
          this.destinationPath('app/js/home/controllers/list.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/notification.controller.js'),
          this.destinationPath('app/js/home/controllers/notification.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/search.controller.js'),
          this.destinationPath('app/js/home/controllers/search.controller.js')
        );
        this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/translate.controller.js'),
          this.destinationPath('app/js/home/controllers/translate.controller.js')
        ); 
         this.fs.copyTpl(
          this.templatePath('scripts/angular/home/controllers/patientSearch.controller.js'),
          this.destinationPath('app/js/home/controllers/patientSearch.controller.js')
        );
        this.fs.copyTpl(
    ...
    html: function() {
      ...
      if (this.includeAngular) {
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/hello.html'),
          this.destinationPath('app/js/home/hello.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/header.html'),
          this.destinationPath('app/js/home/header.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/autocomplete.html'),
          this.destinationPath('app/js/home/autocomplete.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/breadcrumbs.html'),
          this.destinationPath('app/js/home/breadcrumbs.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/list.html'),
          this.destinationPath('app/js/home/list.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/notification.html'),
          this.destinationPath('app/js/home/notification.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/search.html'),
          this.destinationPath('app/js/home/search.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/translate.html'),
          this.destinationPath('app/js/home/translate.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
        ...
        this.fs.copyTpl(
          this.templatePath('html/angular/home/patientSearch.html'),
          this.destinationPath('app/js/home/patientSearch.html'),
          {
            appName: this.appName,
            appDesc: this.appDesc,
            appId: this.appId
